---
title: "Lock-Free Queues and the ABA Problem"
summary: "A pointer that looks unchanged is not proof that nothing happened."
thumbnail: "../images/thumb-9.jpg"
thumbnailAlt: "Abstract gradient cover art for Lock-Free Queues and the ABA Problem"
...
A pointer that looks unchanged is not proof that nothing happened. This post is placeholder content used to exercise the build
...
![Diagram showing the initial approach for Lock-Free Queues and the ABA Problem](../images/fig-9-a.jpg)
...
while (!head.compare_exchange_weak(
  ...
  // old_head reloaded by the CAS on failure
}
```
...
![Benchmark results after applying the fix](../images/fig-9-b.jpg)
