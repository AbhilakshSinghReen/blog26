---
title: "Rust Ownership in Practice"
summary: "Borrowing rules stop being abstract the moment you try to hold two references across an await point."
thumbnail: "../images/thumb-1.jpg"
thumbnailAlt: "Abstract gradient cover art for Rust Ownership in Practice"
...
Borrowing rules stop being abstract the moment you try to hold two references across an await point. This post is placeholder content used to exercise the build
...
![Diagram showing the initial approach for Rust Ownership in Practice](../images/fig-1-a.jpg)
...
![Benchmark results after applying the fix](../images/fig-1-b.jpg)
