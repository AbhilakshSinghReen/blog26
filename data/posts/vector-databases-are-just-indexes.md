---
title: "Vector Databases Are Just Indexes"
summary: "Strip away the marketing and an ANN index is a data structure with a recall knob attached."
thumbnail: "../images/thumb-2.jpg"
thumbnailAlt: "Abstract gradient cover art for Vector Databases Are Just Indexes"
...
Strip away the marketing and an ANN index is a data structure with a recall knob attached. This post is placeholder content used to exercise the build
...
![Diagram showing the initial approach for Vector Databases Are Just Indexes](../images/fig-2-a.jpg)
...
![Benchmark results after applying the fix](../images/fig-2-b.jpg)
