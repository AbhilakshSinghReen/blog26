...
summary: "Cold starts measured in microseconds change which problems are worth solving at the edge."
thumbnail: "../images/thumb-5.jpg"
thumbnailAlt: "Abstract gradient cover art for WASM at the Edge"
...
Cold starts measured in microseconds change which problems are worth solving at the edge. This post is placeholder content used to exercise the build
...
![Diagram showing the initial approach for WASM at the Edge](../images/fig-5-a.jpg)
...
```rust
#[no_mangle]
pub extern "C" fn transform(ptr: *mut u8, len: usize) -> usize {
    let input = unsafe { std::slice::from_raw_parts(ptr, len) };
    input.iter().filter(|b| **b != b' ').count()
}
```
...
![Benchmark results after applying the fix](../images/fig-5-b.jpg)
